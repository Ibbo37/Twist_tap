  ...
  return (
    <>
      ...
      <div className="Wcard-container">
        {/* 5 cards */}
        <div className="Wcard">
          <div className="Wcard-hover-title">Workshop 1</div> {/* Title outside card */}
          <div className="Wimage">
            <img src="/WorkshopImg/HW1.jpg" alt="Workshop" />
          </div>
          <div className="Wtext">
            <h3>Workshop 1</h3>
          </div>
        ...
        <div className="Wcard">
          <div className="Wcard-hover-title">Workshop 2</div> {/* Title outside card */}
          <div className="Wimage">
        ...
        <div className="Wcard">
          <div className="Wcard-hover-title">Workshop 3</div> {/* Title outside card */}
          <div className="Wimage">
            <img src="/WorkshopImg/HW3.jpg" alt="Workshop" />
          </div>
          <div className="Wtext">
            <h3>Workshop 3</h3>
          </div>
        ...
        <div className="Wcard">
          <div className="Wcard-hover-title">Workshop 4</div> {/* Title outside card */}
          <div className="Wimage">
        ...
        <div className="Wcard">
          <div className="Wcard-hover-title">Workshop 5</div> {/* Title outside card */}
          <div className="Wimage">
            <img src="/WorkshopImg/HW5.jpg" alt="Workshop" />
          </div>
          <div className="Wtext">
            <h3>Workshop 5</h3>
          </div>
